...
public class BaseClassMA {
	...
	public void ConfigureAppium() throws IOException {
		...
		FileInputStream file = new FileInputStream(System.getProperty("user.dir")+"\\src\\test\\java\\Resources\\data.properties");
		pro.load(file);
		...
		options.setChromedriverExecutable("C:\\Users\\pmeher\\eclipse-workspace\\Mobile_Automation\\src\\test\\java\\Resources\\chromedriver.exe");
		//options.setApp("C:\\Users\\pmeher\\eclipse-workspace\\Appium\\src\\test\\java\\Resources\\mobileApp\\ApiDemos-debug.apk");
		//options.setApp("C:\\Users\\pmeher\\eclipse-workspace\\Mobile_Automation\\src\\test\\java\\Resources\\General-Store.apk");
		options.setApp("C:\\Users\\pmeher\\eclipse-workspace\\Mobile_Automation\\src\\test\\java\\Resources\\Stock_Trainer.apk");
